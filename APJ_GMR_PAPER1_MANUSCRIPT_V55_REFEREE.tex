...
The SPARC input data are publicly available from the SPARC database. The derived analysis products, radial diagnostic tables, figure-source files, and reproduction scripts are archived at \url{https://doi.org/10.5281/zenodo.20032301} and developed at \url{https://github.com/mohammedmessaoudene-cmd/GMR-SPARC-Paper1}.
